...
public class MqttProviderConfig {
    ...
    public MqttProviderConfig(OkHttpClient httpClient) {
...
//            options.sett
        ...
        mqttClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                String mess = "{\"deviceType\":\"OwnApp\",\"fromDevice\":\"" + deviceName + "\",\"toDevice\":\"" + uuid + "\",\"data\":{\"state\":\"online\",\"timer\":\"000\",\"version\":\"0.1.0\"}}";
                ...
                if (isAliyun) {
                    ...
                    if (topic.contains("rrpc")) {
                        ...
                        String pubTopic = "/sys/" + productKey + "/" + deviceName + "/rrpc/response/" + messageId;
            ...
            public void connectComplete(boolean reconnect, String serverURI) {
                ...
                String s = null;
                try {
                    s = doExecute(request1).body().string();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                Request request2 = new Request.Builder().url("https://iot.diandeng.tech/api/v1/user/device/heartbeat?deviceName=" + deviceName + "&key=" + authKey + "&heartbeat=600")
                        .get()
                        .build();

                try {
                    s = doExecute(request2).body().string();
                } catch (IOException e) {
                    e.printStackTrace();
                }
